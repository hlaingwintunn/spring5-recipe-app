package hwt.guru.spring5recipeapp.bootstarp;

import hwt.guru.spring5recipeapp.model.*;
...
public class RecipeBootstrap implements ApplicationListener<ContextRefreshedEvent> {
    ...
    private List<Recipe> getRecipes() {
        ...
        Optional<UnitOfMeasure> dashUomOptional = unitOfMeasureRepository.findByDescription("Cup");
        ...
        Optional<UnitOfMeasure> cupsUomOptional = unitOfMeasureRepository.findByDescription("Ounce");
